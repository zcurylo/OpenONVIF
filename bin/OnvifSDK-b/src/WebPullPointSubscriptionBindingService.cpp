/* WebPullPointSubscriptionBindingService.cpp
...
{	PullPointSubscriptionBindingService_init(this->soap->imode, this->soap->omode);
	...
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:PullMessages")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/PullMessagesRequest")))
		return serve___tev__PullMessages(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:Seek")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SeekRequest")))
		return serve___tev__Seek(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:SetSynchronizationPoint")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SetSynchronizationPointRequest")))
		return serve___tev__SetSynchronizationPoint(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:GetServiceCapabilities")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetServiceCapabilities")))
		return serve___tev__GetServiceCapabilities(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:CreatePullPointSubscription")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/EventPortType/CreatePullPointSubscriptionRequest")))
		return serve___tev__CreatePullPointSubscription(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "tev:GetEventProperties")) || (this->soap->action && !strcmp(this->soap->action, "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetEventPropertiesRequest")))
		return serve___tev__GetEventProperties(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Renew")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/SubscriptionManager/RenewRequest")))
		return serve___tev__Renew(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Unsubscribe")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/SubscriptionManager/UnsubscribeRequest")))
		return serve___tev__Unsubscribe(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Subscribe")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/SubscribeRequest")))
		return serve___tev__Subscribe(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:GetCurrentMessage")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest")))
		return serve___tev__GetCurrentMessage(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Notify")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/NotificationConsumer/Notify")))
		return serve___tev__Notify(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:GetMessages")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PullPoint/GetMessagesRequest")))
		return serve___tev__GetMessages(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:DestroyPullPoint")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PullPoint/DestroyPullPointRequest")))
		return serve___tev__DestroyPullPoint(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Notify")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PullPoint/Notify")))
		return serve___tev__Notify_(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:CreatePullPoint")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest")))
		return serve___tev__CreatePullPoint(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Renew")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/RenewRequest")))
		return serve___tev__Renew_(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:Unsubscribe")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest")))
		return serve___tev__Unsubscribe_(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:PauseSubscription")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest")))
		return serve___tev__PauseSubscription(this);
	if ((!this->soap->action && !soap_match_tag(this->soap, this->soap->tag, "wsnt:ResumeSubscription")) || (this->soap->action && !strcmp(this->soap->action, "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest")))
