/* WebRemoteDiscoveryBindingService.h
...
#ifndef WebRemoteDiscoveryBindingService_H
#define WebRemoteDiscoveryBindingService_H
#include "WebH.h"
...
{ public:
	...
	virtual	int Hello(wsd__HelloType *dn__Hello, wsd__ResolveType &dn__HelloResponse) SOAP_PURE_VIRTUAL;

	/// Web service operation 'Bye' (returns error code or SOAP_OK)
	virtual	int Bye(wsd__ByeType *dn__Bye, wsd__ResolveType &dn__ByeResponse) SOAP_PURE_VIRTUAL;

	/// Web service operation 'Probe' (returns error code or SOAP_OK)
	virtual	int Probe(wsd__ProbeType *dn__Probe, wsd__ProbeMatchesType &dn__ProbeResponse) SOAP_PURE_VIRTUAL;
};
#endif
